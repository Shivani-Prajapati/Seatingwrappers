...
?>
    ...
    <div id="main-wrapper">
        <div class="unix-login">
             ...
             ?>
            <div class="container-fluid"  style="background-image: url('uploadImage/Logo//logo<?php echo $row_login['background_login_image'];?>');
 background-image:url(uploadImage/student-bg.jpg);height: 757px; margin:0 auto;">
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-st-form">
                                <center><img src="uploadImage/Logo/logo2.jpg" style="width:50%;"></center><br>
                                <form method="POST">
                                  ...
                                  <lable type="button"  value="Back" onclick="history.back()" style="color: white; padding-left: 80px;">Back</lable>
