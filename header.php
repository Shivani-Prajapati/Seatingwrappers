    ...
    <div id="main-wrapper">
        ...
        <div class="header">
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
             ...
             ?>
                        <!--<img src="uploadImage/Logo/logo2.jpg" style="width:50%;">-->
                                ...
                                while($row=mysqli_fetch_array($query))
                                    {
                                      ...
                                      $image = $row['image'];
                                                                    ...
                                                                    ?>
                              <!--<b><img src="uploadImage/Profile/avatar.jpg/<?php echo $row_header_logo['logo'];?>" alt="user" class="dark-logo" style="width:100%;height:auto;"/></b>-->
                              <b><img src="uploadImage/Profile/blank_avatar.png" alt="user" class="profile-pic" /></a></b>
