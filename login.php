...
<?php include('slide/slideshow.php');?>
                        ...
                        <div class="login-content card">
                            <div class="login-form">
                                ...
                                <form method="POST">
                                    ...
                                    <button type="submit" name="btn_login" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="window.location='student.php'">I'm Student</button>

                                    <button type="submit" name="btn_login" class="btn btn-primary btn-flat m-b-30 m-t-30" onclick="window.location='teacher.php'">I'm Teacher</button>
