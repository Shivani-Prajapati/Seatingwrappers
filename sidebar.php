            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    ...
                    <?php } } ?>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fas fa-chalkboard-teacher"></i><span class="hide-menu">Teacher Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <?php } } ?>
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-book"></i><span class="hide-menu">Subject Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <?php } } ?>
                     ...
                     <?php if(isset($useroles)){  if(in_array("manage_class",$useroles)){ ?> 
                        ...
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fas fa-home"></i><span class="hide-menu">Class Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                    ...
                    <?php if(isset($useroles)){  if(in_array("manage_exam",$useroles)){ ?> 
                         <!-- <li class="nav-label">Class</li> -->
                        <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-edit"></i><span class="hide-menu">Exam Management</span></a>
                            <ul aria-expanded="false" class="collapse"> 
                  ...
                  <?php if(isset($useroles)){  if(in_array("manage_user",$useroles)){ ?> 
                    ...
                    <?php if($_SESSION["username"]=='admin') { ?>
                         <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-lock"></i><span class="hide-menu">Staff Permissions</span></a>
                            <ul aria-expanded="false" class="collapse">
                               ...
                               <li><a href="view_role.php">View Role</a></li>
                                   ...
                                   <li> <a class="has-arrow" href="#" aria-expanded="false"><i class="fa fa-user-plus"></i><span class="hide-menu">Staff Management</span></a>
                            <ul aria-expanded="false" class="collapse">
