...
?>    
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                      ...
                      <div class="row">
                    <div class="col-md-4" onclick="window.location='view_teacher.php'">
                        <div class="card bg-primary p-20">
                            <div class="media widget-ten">
                                <div class="media-left meida media-middle">
                                    <span><i class="fas fa-chalkboard-teacher fa-5x"></i></span>
                                </div>
                    ...
                    <div class="col-md-4" onclick="window.location='view_student.php'">
                    ...
                    <div class="col-md-4" onclick="window.location='view_class.php'">
                        <div class="card bg-danger p-20">
                            <div class="media widget-ten">
                                <div class="media-left meida media-middle">
                                    <span><i class="fa fa-table fa-5x"></i></span>
                                </div>
                                <div class="media-body media-text-right">
                    ...
                    <div class="col-md-4" onclick="window.location='view_subject.php'">
